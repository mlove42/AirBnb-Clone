...
const ViewSpots = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setStars("");
        {
            // onSubmit see the below data to their respective stories
    ...
    const handleReviewEdit = (e) => {
        ...
        {
            // once we submit the edit button send data to the store
    ...
    return (
        <>
            {/* data to display on the screen from data pulled from the different stories  */}
